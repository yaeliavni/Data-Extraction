...
setwd("G:/proj/data/r files")    # SET WORKING DIRECTORY, FOLDR WITH INPUT AND OUTPUT SUB FOLDERS
input.folder <- "G:/proj/data/input/"   # DIRECTORY OF FILES TO TRANSFORM. PAY ATTENTION TO \/!! R WORKS WITH /
output.folder <- "G:/proj/data/output/"   # DIRECTORY OF OUTPUT c, g, ex, im,i XLS FILES
